        ...
        if not ret:
            ...
            if intervalTime == 0:
                ...
                if Stu2_isFaceDetected:
                    Stu2_imgV.append(Stu2_Img)
                    Stu2_FaceShapeV.append(Stu2_Faceshapes[0])
                ...
                if len(Stu1_imgV) > 0 and len(Stu2_imgV) > 0 and Recog_flag:
                    Recog_flag = 0
                    imgV = [Stu1_imgV[0], Stu2_imgV[0]]
                    FaceShapeV = [Stu1_FaceShapeV[0], Stu2_FaceShapeV[0]]
        ...
        if not ret:
            ...
            if intervalTime == 0:
                ...
                if Stu3_isFaceDetected:
                    Stu3_imgV.append(Stu3_Img)
                    Stu3_FaceShapeV.append(Stu3_Faceshapes[0])
                ...
                if len(Stu1_imgV) > 0 and len(Stu2_imgV) > 0 and len(Stu3_imgV) > 0 and Recog_flag:
                    Recog_flag = 0
                    imgV = [Stu1_imgV[0], Stu2_imgV[0], Stu3_imgV[0]]
                    FaceShapeV = [Stu1_FaceShapeV[0], Stu2_FaceShapeV[0], Stu3_FaceShapeV[0]]
                    RecogIsIllegal, RecogComparisonMatrix = PairWiseComparison(imgV, FaceShapeV)
                    if RecogIsIllegal:
                        cv2.imwrite(fileName + '_Recognized_Picture_1.jpg', imgV[0])
                        cv2.imwrite(fileName + '_Recognized_Picture_2.jpg', imgV[1])
        ...
        if not ret:
            ...
            if intervalTime == 0:
                ...
                if Stu4_isFaceDetected:
                    Stu4_imgV.append(Stu4_Img)
                    Stu4_FaceShapeV.append(Stu4_Faceshapes[0])
        ...
        if not ret:
            ...
            if intervalTime == 0:
                ...
                if Stu5_isFaceDetected:
                    Stu5_imgV.append(Stu5_Img)
                    Stu5_FaceShapeV.append(Stu5_Faceshapes[0])
        ...
        if not ret:
            ...
            if intervalTime == 0:
                ...
                if Stu6_isFaceDetected:
                    Stu6_imgV.append(Stu6_Img)
                    Stu6_FaceShapeV.append(Stu6_Faceshapes[0])
